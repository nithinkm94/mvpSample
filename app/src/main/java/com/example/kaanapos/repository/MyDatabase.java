...
//@Database(entities = {CategoryWiseList.class , MenuItem.class , Modifier.class , ItemVarientJoint.class ,
//        MaterialVariant.class ,  ModifierItem.class , DiscountSetting.class , Tax.class,
//        TicketAddItemModel.class, TicketListModel.class, TicketModifierItem.class,
//        TicketItemVarients.class, SaveOrderRequest.class}, version = 96
